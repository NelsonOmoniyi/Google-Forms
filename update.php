...
$sql = "UPDATE 'form' SET 'firstName' = '$firstname', 'lastName' = '$lastname', 'email' = '$email', 'mNumber' = '$mobile', 'title' = '$title', 'picture' = '$picture'";

$result = $conn->query($sql);

if ($result == TRUE) {
    echo '<script type="text/javascript"> alert("Your Data Have Been Updated Successfuly"); </script>';
}else{
    echo '<script type="text/javascript"> alert("An Error Occurred while trying to update your data"); </script>';
}
...
if (isset($_GET['ID'])) {
    $id = $_GET['ID'];
        ...
        $sql = "SELECT * FROM 'form' WHERE 'form' 'ID' = '$id'";
        $result = $conn->query($sql);
            ...
            <form action="index.php" method="POST">
                ...
                <div class="firstName-div">
                    ...
                    <div class="input-div1 input">
                        <input type="text" name="firstName" placeholder="Your answer" required maxlength="30" value="<?php echo $firstname; ?>">
                    </div>
                ...
                <div class="lastName-div">
                    ...
                    <div class="input-div2 input">
                        <input type="text" name="lastName" placeholder="Your answer" required maxlength="30" value="<?php echo $lastname; ?>"> 
                    </div>
                 ...
                 <div class="email-div">
                    ...
                    <div class="input-div3 input">
                        <input type="email" name="email" placeholder="Your answer" required maxlength="50" value="<?php echo $email; ?>">
                    </div>
                </div>
                ...
                <div class="mNumber-div">
                    ...
                    <div class="input-div4 input">
                        <input type="number" name="mNumber" placeholder="Your answer" required maxlength="20" value="<?php echo $mobile; ?>">
                    </div>
                ...
                <div class="Ttitle-div">
                    ...
                    <div class="input-div5 input">
                        <input type="text" name="title" placeholder="Your answer" required maxlength="30" value="<?php echo $title; ?>">
                    </div>
                </div>
